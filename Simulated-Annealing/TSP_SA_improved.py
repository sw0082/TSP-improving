...
def simulated_annealing(path_map, path):
    ...
    global TEMPERATURE
    global prob_times
    minoftemp = 0.8474*(len(coord_list)) - 81.052
    if minoftemp < 1:
        minoftemp = 1
    while TEMPERATURE > minoftemp:
...
print('Under Prob. Seleceted Times: ' + str(prob_times))

print('len of coordlilst: ' + str(len(coord_list)))
